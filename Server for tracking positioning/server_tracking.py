...
def log_data():
    ...
    try:
        ...
        row = [
            ...
            float(data['dist0']) if data['dist0'] is not None else '',
            float(data['dist1']) if data['dist1'] is not None else '',
            float(data['dist2']) if data['dist2'] is not None else '',
            float(data['dist3']) if data['dist3'] is not None else '',
            float(data['x']),
            float(data['y']),
        ]
